CivicNet Core version 0.21.5.5 is now available from:

 <https://download.civicnet.org/civicnet-0.21.5.5/>.
...
- Replaced the functional test dependency on the external `civicnet_scrypt`
