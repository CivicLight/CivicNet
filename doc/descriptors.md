# Support for Output Descriptors in CivicNet Core

Since CivicNet Core v0.17, there is support for Output Descriptors. This is a
...
existing CivicNet Core wallets, a convenience function `combo` is
