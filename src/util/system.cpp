...
const char * const BITCOIN_CONF_FILENAME = "civicnet.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CivicNet";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/CivicNet";
#else
    // Unix-like
    return pathRet / ".civicnet";
#endif
#endif
}
