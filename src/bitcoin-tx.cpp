...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " civicnet-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  civicnet-tx [options] <hex-tx> [commands]  Update hex-encoded civicnet transaction\n" +
            "or:     civicnet-tx [options] -create [commands]   Create hex-encoded civicnet transaction\n" +
            "\n";
