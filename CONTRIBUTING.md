Contributing to CivicNet Core
============================

The CivicNet Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the CivicNet Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/civicnet-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to civicnet-qt
...
The following applies to code changes to the CivicNet Core project (and related
projects such as libsecp256k1), and is not to be confused with overall CivicNet
Network Protocol consensus changes.

Whether a pull request is merged into CivicNet Core rests with the project merge
...
Patches that change CivicNet consensus rules are considerably more involved than
...
Where a patch set proposes to change the CivicNet consensus, it must have been
...
The project leader is the release manager for each CivicNet Core release.
