...
"""Verify that starting civicnet with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start civicnet with -h for help text")
        ...
        self.log.info("Start civicnet with -version for version information")
        ...
        self.log.info("Start civicnetd with -fakearg to make sure it does not start")
